...
export const RENDER_CONTRACT_DATA = {
  ...
  "render_graph": {
    ...
    "aliasing": {
      ...
      "note": "Dois recursos com a mesma chave e janelas de vida disjuntas dividem a alocação; com os passes de cabelo/pós-processamento desabilitados o plano não tem nada para compartilhar (e reporta 0 bytes).",
      "groups": [
        {
          "name": "oit_and_bloom",
          "members": [
