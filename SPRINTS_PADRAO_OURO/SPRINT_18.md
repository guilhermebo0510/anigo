...
# SPRINT 18: Shaders Especializados para Background Art (Painterly / Estilo Ghibli)

## 1. Objetivo e Escopo Industrial
Shaders de acabamento pictorico tradicional, pigmento de aquarela, granulacao procedural e folhagens volumétricas estilizadas (cloud foliage).

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: shaders/painterly_background.wgsl
...
- **Ferramentas MCP a executar e auditar**: anigo_set_environment_shader, anigo_render_frame, anigo_compare_baseline
...
- Cenarios ganham visual de pintura artesanal japonesa em harmonia com os personagens.
