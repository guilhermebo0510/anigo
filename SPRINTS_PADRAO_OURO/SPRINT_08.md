...
# SPRINT 08: Desacoplamento Facial, Decalques, Parallax de Iris e 52 Blendshapes ARKit

## 1. Objetivo e Escopo Industrial
Camadas de decalques desacopladas (sobrancelhas sobre o cabelo), efeito de profundidade de iris com parallax reverso e 52 morph targets FACS/ARKit.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: crates/anigo-core/facial, src/components/character/FaceEditor.svelte
...
- **Ferramentas MCP a executar e auditar**: anigo_set_blendshape_weights, anigo_render_frame, anigo_compare_baseline
...
- Sobrancelha visivel atraves da franja e transicoes expressivas fluidas sem artefatos de z-fighting.
