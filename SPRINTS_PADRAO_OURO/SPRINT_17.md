...
# SPRINT 17: Blocagem Modular de Cenarios 3D (Greybox, Snapping e Instancing wgpu)

## 1. Objetivo e Escopo Industrial
Scene graph de ambientes com grid snapping magnetico e renderizacao instanciada wgpu para milhares de elementos cenicos a 120 FPS.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: crates/anigo-scene, src/components/environment/BlockoutEditor.svelte
...
- **Ferramentas MCP a executar e auditar**: anigo_spawn_blockout_mesh, anigo_render_frame, anigo_get_scene_metrics
...
- Montagem de sala de aula ou rua residencial em minutos com performance de 120+ FPS.
