...
# SPRINT 14: Deformadores de Impacto (Smear Frames / Obake) e Assistente de Arcos

## 1. Objetivo e Escopo Industrial
Modificador de deformacao extrema de malha para quadros de impacto (Smear Frames) com preservacao de arcos de movimento desenhados.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: crates/anigo-animation/deformers
...
- **Ferramentas MCP a executar e auditar**: anigo_apply_smear, anigo_render_frame, anigo_compare_baseline
...
- Golpes de alta velocidade exibem alongamento estético convincente de celuloide em 1 frame.
