...
# SPRINT 15: Rigging Secundario Expressivo, Curvas de Acao e Espelhamento de Poses

## 1. Objetivo e Escopo Industrial
Restricoes de osso para curvas de acao extremas, compensadores de escorco (foreshortening) de manga e espelhamento inteligente de poses.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: crates/anigo-animation/rigging
...
- **Ferramentas MCP a executar e auditar**: anigo_mirror_pose, anigo_apply_foreshortening, anigo_render_frame
...
- Poses de acao dramatica com deformacao de perspectiva sem quebrar pesos de pele.
