...
# SPRINT 19: Camera Projection Mapping 2.5D para Cenarios Hibridos

## 1. Objetivo e Escopo Industrial
Projecao de ilustracoes 2D sobre geometria 3D simplificada com calibracao de fuga e compensacao de oclusao para travellings de camera com paralaxe.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: shaders/camera_projection.wgsl, crates/anigo-scene/projection
...
- **Ferramentas MCP a executar e auditar**: anigo_calibrate_projection, anigo_render_frame, anigo_move_camera_track
...
- Navegacao fluida de camera sobre pintura 2D com separacao de planos e paralaxe natural.
