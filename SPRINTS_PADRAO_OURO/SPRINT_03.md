...
# SPRINT 03: Manequim Anatomico e Deformacao por Caixas de Volume com Green Coordinates

## 1. Objetivo e Escopo Industrial
Manipulacao de volumes corporais via cages 3D, solver Green Coordinates para preservacao estrita de volume e coordenadas laplacianas.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: crates/anigo-core/volumetric, solvers/green_coordinates.rs
...
- **Ferramentas MCP a executar e auditar**: anigo_deform_segment, anigo_inspect_mesh_integrity, anigo_render_frame
...
- Escala anatomica de 2 a 8.5 cabecas sem estreitamento ou colapso de vertices em poses extremas.
