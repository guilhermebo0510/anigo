...
# SPRINT 02: Pipeline Cel-Shading NPR Avancado e Sistema de Luzes Toon

## 1. Objetivo e Escopo Industrial
Shader WGSL cel-shading com amostragem Toon Ramp 1D/2D, Hue-Shifting matematico em sombras, oclusao estipulada em vertex color e specular anisotrópico.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: shaders/cel_shading.wgsl, crates/anigo-renderer
...
- **Ferramentas MCP a executar e auditar**: anigo_set_light, anigo_set_material_toon, anigo_render_frame, anigo_compare_baseline
...
- Transicao nitida de anime sem serrilhado, sombra fria lavanda e specular com jitter.
