...
# SPRINT 05: Normais Customizadas, SDF Face Shadow Map e Contorno Inverted Hull

## 1. Objetivo e Escopo Industrial
Passe de contorno Inverted Hull compensado por W, transferencia k-NN de normais elipsoidais e mapas SDF de sombra facial estilo Genshin Impact.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: shaders/inverted_hull.wgsl, shaders/face_sdf.wgsl
...
- **Ferramentas MCP a executar e auditar**: anigo_set_face_light_angle, anigo_render_frame, anigo_compare_baseline
...
- Sombra de nariz e bochechas sem quebras poligonais em 360 graus e contorno com espessura uniforme.
