...
# SPRINT 09: Pintura de Texturas 3D/2D, Camadas de Materiais e Decalques Livres

## 1. Objetivo e Escopo Industrial
Pincel 3D projetado por raycasting sobre UV e malha, suporte a multiplas camadas de textura (pele, olhos, roupa, blush) e mascaras de contorno.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: crates/anigo-paint, shaders/texture_paint.wgsl
...
- **Ferramentas MCP a executar e auditar**: anigo_paint_stroke, anigo_export_texture_atlas, anigo_render_frame
...
- Pintura direta sobre o modelo em tempo real sem latencia ou quebra de costura UV.
