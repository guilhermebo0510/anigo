...
# SPRINT 10: Alfaiataria Parametrica 2D/3D e Dobras Estilizadas de Anime

## 1. Objetivo e Escopo Industrial
Modelos de costura 2D drapeados no manequim 3D, camadas anti-interpenetracao e gerador de dobras tubulares estilizadas de anime.

## 2. Pacotes e Arquitetura Envolvida
- **Módulos / Crates**: crates/anigo-cloth, shaders/cloth_folds.wgsl
...
- **Ferramentas MCP a executar e auditar**: anigo_drape_garment, anigo_render_frame, anigo_check_cloth_collisions
...
- Vestuario acompanha deformacao anatomica sem penetracao na pele e exibe vincos nitidos.
