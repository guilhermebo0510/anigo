...
mod tests {
    ...
    fn parents_propagate_into_children() {
        let nodes = vec![
            slot("nod_root", None, translation(1.0, 0.0, 0.0)),
            slot("nod_child", Some("nod_root"), translation(0.0, 2.0, 0.0)),
        ];
    ...
    fn five_level_hierarchy_matches_glam_expectation() {
        ...
        let nodes = vec![
            slot("nod_level0", None, translation(0.5, 0.0, 0.0)),
            slot("nod_level1", Some("nod_level0"), translation(0.0, 0.5, 0.0)),
            slot(
                "nod_level2",
                Some("nod_level1"),
                Transform {
            ...
            slot("nod_level3", Some("nod_level2"), translation(1.0, 0.0, 0.0)),
            slot("nod_level4", Some("nod_level3"), translation(0.0, 0.0, 0.25)),
        ];
    ...
    fn declaration_order_does_not_matter_for_resolution() {
        ...
        let nodes = vec![
            slot("nod_child", Some("nod_parent"), translation(0.0, 1.0, 0.0)),
            slot("nod_parent", None, translation(2.0, 0.0, 0.0)),
        ];
        let world = resolve_world_transforms(&nodes).expect("árvore válida");
        let child = world
            .get(&nid("nod_child"))
    ...
    fn cycles_are_rejected_with_a_named_path() {
        let nodes = vec![
            slot("nod_a", Some("nod_c"), translation(0.0, 0.0, 0.0)),
            slot("nod_b", Some("nod_a"), translation(0.0, 0.0, 0.0)),
            slot("nod_c", Some("nod_b"), translation(0.0, 0.0, 0.0)),
        ];
    ...
    fn self_parent_and_unknown_parent_are_rejected() {
        let nodes = vec![slot("nod_a", Some("nod_a"), Transform::default())];
        assert_eq!(
        ...
        let nodes = vec![slot("nod_a", Some("nod_missing"), Transform::default())];
        assert_eq!(
            validate_hierarchy(&nodes),
    ...
    fn duplicated_ids_are_rejected() {
        let nodes = vec![
            slot("nod_a", None, Transform::default()),
            slot("nod_a", None, Transform::default()),
        ];
        assert_eq!(
            validate_hierarchy(&nodes),
    ...
    fn descendants_and_ancestors_walk_the_tree_in_order() {
        let nodes = vec![
            slot("nod_root", None, Transform::default()),
            slot("nod_a", Some("nod_root"), Transform::default()),
