      ...
      materials: [
        {
          ...
          toon_steps: 1,
          ao_intensity: 0.85,
          // Fase 2 (#18): MToon (VRMC_materials_mtoon) — default = tudo off
          mtoon_emission_color: [0, 0, 0, 0],
          mtoon_emission_intensity: 0,
          mtoon_second_shade_shift: 0,
          mtoon_second_shade_softness: 0.05,
          mtoon_matcap_intensity: 0,
